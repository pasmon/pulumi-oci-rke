...
#    error: no resource plugin 'oci-v0.0.0' found in the workspace or on your $PATH, install the plugin using `pulumi plugin install resource oci v0.0.0`
# oci.core.Instance("oci-instance",
#                 availability_domain="AD-1",
#                 compartment_id="disssko",
#                 shape="VM.Standard.E3.Flex")

def write_kubeconfig(data):
  with open("out/rke_kubeconfig", "w") as kubeconfig:
